...
const getProductLayoutData = async () => {
...
const setProductPageAsyncLayout = async () => {
  const main = document.querySelector("main") as HTMLDivElement;
  main.innerHTML = await getProductLayoutData();
};

export default setProductPageAsyncLayout;
